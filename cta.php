...
<script type='text/javascript'>
  $(function() {
    var overlay = $('<div class="il" id="overlay"></div>');
    $(document).ready(function(){
      setTimeout(function(){
        $('.megapop').show();;
        overlay.show();
        overlay.appendTo(document.body);
      },7000); // on load 15seconds after
    });
...
<div class='megapop bd-example-modal-lg' id ="close">
    <div id="custom_pop_up" class="bd-example-modal-lg fluid container">
      ...
      <div class="container text-center">
       <img class="img-fluid" src="https://zaqya.com/wp-content/uploads/2021/07/PROMO-TODAY.jpg">
      </div>
...
<script> $(document).ready(function() { $(window).scroll(function() { if ($(window).scrollTop() >= ($(document).height() - $(window).height())) { $('.popup').css( "left", "20px" ) $('.arrow').hide(); }else{ $('.popup').css( "left", "-380px" ); } }); $('.closed').click(function(){ $('.popup').hide(); }); }); $('.arrow').click(function(){ $('.popup').show(); }); </script>
  <!-- Popup START -->
  <!-- <div class="popup">
  ...
  <!-- Popup END -->
<style> .popup { z-index: 9999; width: 380px; height: 180px; background: gray; bottom: 20px; right: 20px; position: fixed; border-radius: 5px; box-shadow: 0px 25px 10px -15px rgba(0, 0, 0, 0.05); transition: 0.5s; z-index: 99999; } .closed { position: absolute; top: 5px; right: 5px; width: 20px; height: 20px; cursor: pointer; z-index: 500; } .ns-close { width: 20px; height: 20px; position: absolute; right: 4px; top: 4px; overflow: hidden; text-indent: 100%; cursor: pointer; -webkit-backface-visibility: hidden; backface-visibility: hidden; } .ns-close:hover, .ns-close:focus { outline: none; } .ns-close::before, .ns-close::after { content: ""; position: absolute; width: 3px; height: 60%; top: 50%; left: 50%; background: var(--clr2); } .ns-close:hover::before, .ns-close:hover::after { background: #fff; } .ns-close::before { -webkit-transform: translate(-50%, -50%) rotate(45deg); transform: translate(-50%, -50%) rotate(45deg); } .ns-close::after { -webkit-transform: translate(-50%, -50%) rotate(-45deg); transform: translate(-50%, -50%) rotate(-45deg); } @keyframes bounce { 0%, 20%, 50%, 80%, 100% { -moz-transform: translateY(0); -ms-transform: translateY(0); -webkit-transform: translateY(0); transform: translateY(0); } 40% { -moz-transform: translateY(-30px); -ms-transform: translateY(-30px); -webkit-transform: translateY(-30px); transform: translateY(-30px); } 60% { -moz-transform: translateY(-15px); -ms-transform: translateY(-15px); -webkit-transform: translateY(-15px); transform: translateY(-15px); } } .arrow { position: fixed; bottom: 50px; left: 50%; cursor: pointer; margin-left: -20px; width: 20px; height: 20px; padding: 20px; z-index: 99; background-color: blue; border-radius: 50em; background-image: url(data:image/svg+xml;base64,); background-size: 20px 15px; background-repeat: no-repeat; background-position: center; } .bounce { -moz-animation: bounce 2s infinite; -webkit-animation: bounce 2s infinite; animation: bounce 2s infinite; } @media (max-width: 728px) { section.cards .card { width: 100%; display: block; margin: 10px 0 0 0 !important; padding: 0; } .popup { width: 280px; } } </style>
...
const number=['6283869905976','6287786131429','6283840399019','6281914323478'];

   $(function () {
           $('#WAButton').floatingWhatsApp({
               phone: number[0], //WhatsApp Business phone number
               headerTitle: 'Customer Support', //Popup Title
               ...
               message: 'Waalaikumsalam, saya mau tanya nih',
