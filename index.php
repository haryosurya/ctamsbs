...
<body>	
	...
	<div class="animsition">
									...
									<div class="collapse navbar-collapse" id="navbarSupportedContent">
										<ul class="navbar-nav ml-auto pt-4 pt-xl-0 mr-xl-4">
											<li class="nav-item dropdown">
												<a class="nav-link active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">Home</a>
												<div class="dropdown-menu">
													<ul class="p-0 m-0">
														...
														<li class="nav-item">
															<a class="dropdown-item active animsition-link" href="home-startup.html">Home - startup</a>
														</li>
														<li class="nav-item">
														...
														<li class="nav-item dropdown-2">
															...
															<div class="dropdown-menu drop-right-sub">
																<ul class="p-0 m-0">
																	...
																	<li class="nav-item">
																		<a class="dropdown-item" data-gal='m_PageScroll2id' href="#footer">Footer v3</a>
																	</li>
																	<li class="nav-item">
											...
											<li class="nav-item dropdown mega-menu-dropdown-link">
												<a class="nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">Pages</a>
														...
														<div class="row">
															...
															<div class="col-md-6 col-xl-3">
																<ul class="p-0 m-0">
																	...
																	<li class="nav-item">
																		<a class="dropdown-item animsition-link" href="recovery.html">Recovery password</a>
																	</li>
																	<li class="nav-item">
													...
													<div class="container-fluid">
														<div class="row">
															...
															<div class="col-12 pt-3 pb-3">
																<div class="section px-sm-3">
																	<div class="row">
																		<div class="col-sm align-self-center text-xl-right">
																			<h4 class="mb-0">More than <span class="color-primary">1000+</span> UI Features included!</h4>
																		</div>
																		<div class="col-sm-auto align-self-center mt-4 mt-sm-0"> 
																			<a href="shortcodes.html" class="btn btn-primary-gradient animsition-link"><i class="uil uil-arrow-circle-right size-22 mr-2"></i>Discover All</a> 
																		</div>
																	</div>
																</div>
															</div>
				...
				<div class="modal-content">
					<div class="modal-body z-bigger">
						<div class="container-fluid">
							...
							<div class="row">
								<div class="col-12">
									<h5 class="mb-3 pb-3">Shopping cart</h5>
								</div>
								<div class="col-sm-4 img-wrap mb-2 mb-sm-0">
									<img class="border-4" src="img/shop-1.jpg" alt="shop cart">
								</div>
								<div class="col align-self-center">
									<a href="" class="link mr-3" data-hover="Old retro suitcase">Old retro suitcase</a> 
							...
							<div class="row mt-3">
								...
								<div class="col align-self-center">
									<a href="" class="link mr-3" data-hover="Blank retro sign">Blank retro sign</a> 
							...
							<div class="row mt-3">
								...
								<div class="col align-self-center">
									<a href="" class="link mr-3" data-hover="Mechanical weight scale">Mechanical weight scale</a> 
							...
							<div class="row mt-5">
								<div class="col-sm align-self-center">
									<p class="mb-0 lead color-dark-blue size-24 font-weight-500">Total: <span class="font-weight-bold">$1107</span></p>
								</div>
		...
		<div class="section over-hide full-height full-height-xl section-background-3">
			<div class="hero-center-section">
				<div class="section-1400">
					<div class="container-fluid">
						<div class="row justify-content-center">
							<div class="col-12 parallax-fade-hero-short text-center">
								<h1 class="display-1 mb-4 mb-lg-5">
									Designed for your satisfaction
								</h1>
							</div>
							<div class="col-auto parallax-fade-hero-short">
								<a href="#page-section" class="text-decoration-none" data-gal='m_PageScroll2id' data-ps2id-offset="80">
									<p class="font-weight-700 mb-0 size-18 text-vertical color-gray">
										discover
										<i class="uil uil-arrow-down size-20 mt-3"></i>
									</p>
								</a>
							</div>
						</div>
		...
		<div class="section bg-light-2">
			<div class="section px-2 over-hide translate-top-120">
				<div class="container-fluid">
					<div class="row justify-content-center">
						<div class="col-12">
							<div class="section swiper-startup padding-bottom-80 pt-3">
								<div class="swiper-wrapper">
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-1.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-1.jpg" alt="">
											</div>
										</a>
									</div>
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-2.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-2.jpg" alt="">
											</div>
										</a>
									</div>
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-3.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-3.jpg" alt="">
											</div>
										</a>
									</div>
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-4.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-4.jpg" alt="">
											</div>
										</a>
									</div>
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-5.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-5.jpg" alt="">
											</div>
										</a>
									</div>
									<div class="swiper-slide separator-wrap-1">
										<a href="img/sep-6.jpg" data-fancybox="">
											<div class="section img-wrap">
												<img class="border-4 separator-img-shadow" src="img/sep-6.jpg" alt="">
											</div>
										</a>
									</div>
								</div>
		...
		<div class="section over-hide padding-top-80 padding-bottom-120 section-background-1" id="page-section">
			<div class="section-1400">
				<div class="container-fluid">
					<div class="row justify-content-center padding-bottom-80">
						<div class="col-md-7 col-lg-6 col-xl-5 text-center">
							<p class="lead mb-3 text-uppercase font-weight-700">
								<span class="title-text-top">core features</span>
							</p>
							<h3 class="mb-4">
								We provide solution.
							</h3>
					...
					<div class="row justify-content-center">
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-4.svg" alt="">
							<h5 class="mb-3">
								Pixel Perfect
							</h5>
							<p class="mb-0">
						...
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1 mt-5 mt-sm-0" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-5.svg" alt="">
							<h5 class="mb-3">
								Creative Design
							</h5>
							<p class="mb-0">
						...
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1 mt-5 mt-lg-0" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-6.svg" alt="">
							<h5 class="mb-3">
								Smart Tools
							</h5>
							<p class="mb-0">
						...
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1 mt-5" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-7.svg" alt="">
							<h5 class="mb-3">
								Heigh Perfomance
							</h5>
							<p class="mb-0">
						...
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1 mt-5" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-8.svg" alt="">
							<h5 class="mb-3">
								Easy to Use
							</h5>
							<p class="mb-0">
						...
						<div class="col-sm-6 col-lg-4 text-center services-wrap-1 mt-5" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<img class="mb-3 mx-auto" src="img/icon-9.svg" alt="">
							<h5 class="mb-3">
								Page Speed
							</h5>
							<p class="mb-0">
		...
		<div class="section over-hide padding-top-bottom-120 section-background-4">
			<div class="section-background-gradient-white-gray"></div>
			<div class="section-1400 z-bigger">
				<div class="container-fluid">
					<div class="row justify-content-center justify-content-lg-start">
						<div class="col-sm-11 col-md-9 offset-lg-6 col-lg-5">
							<p class="mb-3 text-uppercase font-weight-700 text-center text-lg-left">
								<span class="title-text-top">testimonials</span>
							</p>
							<h4 class="mb-5 text-center text-lg-left">
								Check what's our clients<br>say about us
							</h4>						
							<div class="section swiper-testimonials over-hide">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="section testimonials-v2 bg-white">
											<p class="lead mb-0">Aenean lacinia bibendum nulla sed consectetur. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo.</p>
										</div>
										<div class="row testimonials-v2-img mt-4">
											...
											<div class="col align-self-center">
												<h6 class="mb-0">Travis Scott</h6>
												<p class="mb-0 size-14 color-gray-dark">Company</p>
											</div>
										</div>	
									</div>
									<div class="swiper-slide">
								...
								<div class="swiper-button-prev"><i class="uil uil-arrow-left size-24"></i></div>
								<div class="swiper-button-next"><i class="uil uil-arrow-right size-24"></i></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="section over-hide padding-top-120">
			<div class="section-1400">
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-5 offset-xl-1 col-xl-4 align-self-center text-center text-lg-left mb-5 mb-lg-0">
							<p class="lead mb-3 text-uppercase font-weight-700">
								<span class="title-text-top">our pricing</span>
							</p>
							<h3 class="mb-4">
								Not any hidden charge.
							</h3>
							<p class="lead mb-5">
								we have offere type of pricing table to choose with your need with resonable price
							</p>
							<div class="form-group text-center text-lg-left">
								<input class="pricing-opt" type="checkbox" id="pricing">
								<label class="switch-pricing mb-0" for="pricing"></label>
							</div>
						</div>
						<div class="col-lg-6 order-lg-first align-self-center">
							<div class="section pricing-wrap-1 border-4 over-hide  bg-light-2">
								<div class="row">
									<div class="col-sm-auto text-center">
										<div class="section bg-primary">
											<h2 class="mb-0 color-white px-5 pt-5 pb-4 size-40">
												<sup class="size-22 pr-1">$</sup>12.<sup class="size-24">99</sup>
											</h2>
											<h5 class="mb-0 color-white pb-5">
												business
											</h5>
											<button type="button" class="btn btn-pricing size-22 btn-fluid">Start Now</button>
										</div>
									</div>
									<div class="col-sm align-self-center py-4 py-sm-0 px-5 px-sm-4 px-xl-5">
										<p class="lead mb-2 font-weight-700">
											25% OFF
										</p>
										<h5 class="mb-4">
											Monthly package
							...
							<div class="section pricing-wrap-1 border-4 over-hide  bg-light-2 pricing-opt-2">
								<div class="row">
									<div class="col-sm-auto text-center">
										<div class="section bg-primary">
											<h2 class="mb-0 color-white px-5 pt-5 pb-4 size-40">
												<sup class="size-22 pr-1">$</sup>99.<sup class="size-24">99</sup>
											</h2>
											<h5 class="mb-0 color-white pb-5">
												business
											</h5>
											<button type="button" class="btn btn-pricing-2 size-22 btn-fluid">Start Now</button>
										</div>
									</div>
									<div class="col-sm align-self-center py-4 py-sm-0 px-5 px-sm-4 px-xl-5">
										<p class="lead mb-2 font-weight-700">
				...
				<div class="container-fluid">
					<div class="row justify-content-center padding-bottom-80">
						<div class="col-md-7 col-lg-6 col-xl-5 text-center">
							...
							<p class="lead mb-0">
								A digital marketing company that can produce custom-built websites and mobile applications.
							</p>
						</div>
					</div>
					<div class="row justify-content-center">
						<div class="col-12 text-center">
							<div class="section swiper-team padding-bottom-80">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="section bg-light-2 over-hide border-4 img-wrap team-wrap-1">
											<img src="img/t1.jpg" alt="">
											<div class="section py-4">
												<p class="mb-1 size-14 color-secondary">CEO</p>
												<h6 class="mb-3">Abbie Miller</h6>
												<p class="mb-0">
													<a href="#" class="link-heading"><i class="uil uil-dribbble size-20 mx-2"></i></a>
													<a href="#" class="link-heading"><i class="uil uil-twitter-alt size-20 mx-2"></i></a>
													<a href="#" class="link-heading"><i class="uil uil-github-alt size-20 mx-2"></i></a>
												</p>
											</div>
										</div>
									</div>
			...
			<div class="section-1400">
				<div class="container-fluid">
					<div class="row justify-content-center padding-bottom-80">
						<div class="col-md-7 col-lg-6 col-xl-5 text-center">
							<p class="lead mb-3 text-uppercase font-weight-700">
								<span class="title-text-top">OUR NEWS</span>
							</p>
							<h3 class="mb-4">
					...
					<div class="row justify-content-center">
						<div class="col-sm-6 col-xl-5 px-xl-4" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<div class="row mb-5">
								<div class="col-12 mb-4 mb-sm-0 order-sm-last img-wrap">
									<img class="border-4" src="img/blog-1.jpg" alt="">
								</div>
								<div class="col-12 mb-0 mb-sm-4">
									<p class="mb-3 size-18">
										<a href="#" class="tag new">couple</a>
										<a href="#" class="tag popular">trip</a>
										<a href="#" class="tag sale">road</a>
									</p>
									<p class="mb-1 size-16">
										10.Sep. by						
										<a href="about-me-creative.html" class="link size-16 animsition-link" data-hover="Fred Johnston">Fred Johnston</a>
									</p>
									<h5 class="mb-4">
										<a href="post-1.html" class="link-heading animsition-link">View of couple on road trip</a>
									</h5>
									<div class="row">
										<div class="col-md-auto">
											<h3 class="mb-0 font-weight-400 color-gray d-none d-md-block">
												01
											</h3>
										</div>
										<div class="col">
											...
											<a href="post-1.html" class="link size-16 link-normal text-center-v animsition-link">More Details <i class="uil uil-arrow-right ml-2"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6 col-xl-5 px-xl-4" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<div class="row mb-5">
								<div class="col-12 mb-4 img-wrap">
									<img class="border-4" src="img/blog-3.jpg" alt="">
								</div>
								<div class="col-12">
									<p class="mb-3 size-18">
										<a href="#" class="tag hot">man</a>
										<a href="#" class="tag info">dog</a>
										<a href="#" class="tag popular">trip</a>
										<a href="#" class="tag sale">road</a>
									</p>
									<p class="mb-1 size-16">
									...
									<h5 class="mb-4">
										<a href="post-1.html" class="link-heading animsition-link">Man with dog on road trip</a>
									</h5>
									<div class="row">
										<div class="col-md-auto">
											<h3 class="mb-0 font-weight-400 color-gray d-none d-md-block">
						...
						<div class="col-sm-6 col-xl-5 px-xl-4" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<div class="row mb-5 mb-sm-0">
								<div class="col-12 mb-4 mb-sm-0 order-sm-last img-wrap">
									<img class="border-4" src="img/blog-2.jpg" alt="">
								</div>
								<div class="col-12 mb-0 mb-sm-4">
									<p class="mb-3 size-18">
										<a href="#" class="tag info">people</a>
										<a href="#" class="tag sale">camping</a>
										<a href="#" class="tag hot">river</a>
									</p>
									<p class="mb-1 size-16">
										05.Sep. by						
										<a href="about-me-creative.html" class="link size-16 animsition-link" data-hover="Fred Johnston">Fred Johnston</a>
									...
									<h5 class="mb-4">
										<a href="post-1.html" class="link-heading animsition-link">People camping by the river</a>
									</h5>
									<div class="row">
										<div class="col-md-auto">
											<h3 class="mb-0 font-weight-400 color-gray d-none d-md-block">
						...
						<div class="col-sm-6 col-xl-5 px-xl-4" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<div class="row">
								<div class="col-12 mb-4 img-wrap">
									<img class="border-4" src="img/blog-4.jpg" alt="">
								</div>
								<div class="col-12">
									<p class="mb-3 size-18">
										<a href="#" class="tag popular">smiling</a>
										<a href="#" class="tag new">couple</a>
										<a href="#" class="tag sale">signpost</a>
									</p>
									<p class="mb-1 size-16">
										02.Sep. by						
										<a href="about-me-creative.html" class="link size-16 animsition-link" data-hover="Fred Johnston">Fred Johnston</a>
									...
									<h5 class="mb-4">
										<a href="post-1.html" class="link-heading animsition-link">Smiling couple at signpost</a>
									</h5>
									<div class="row">
										<div class="col-md-auto">
											<h3 class="mb-0 font-weight-400 color-gray d-none d-md-block">
						...
						<div class="col-12 text-center padding-top-80" data-scroll-reveal="enter bottom move 40px over 0.5s after 0.3s">
							<a href="blog-mixed.html" class="btn btn-dark animsition-link">See All Posts<i class="uil uil-arrow-right size-22 ml-3"></i></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section over-hide pb-4">
			<div class="section-1400">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="section border-4 bg-light-2 py-5">
								<div class="row justify-content-center">
									<div class="col-md-6 col-lg-3 text-center border-counters-right">
										<div class="h3 mb-1"><span class="counter">1270</span>+</div>
										<p class="lead mb-0">
											Completed Projects
										</p>
									</div>
									<div class="col-md-6 col-lg-3 mt-5 mt-md-0 text-center border-counters-right">
										<div class="h3 mb-1"><span class="counter">37</span></div>
										<p class="lead mb-0">
											Availble Country
										</p>
									</div>
									<div class="col-md-6 col-lg-3 mt-5 mt-lg-0 text-center border-counters-right">
										<div class="h3 mb-1"><span class="counter">173</span>M</div>
										<p class="lead mb-0">
											User Worldwide
										</p>
									</div>
									<div class="col-md-6 col-lg-3 mt-5 mt-lg-0 text-center">
										<div class="h3 mb-1"><span class="counter">17</span></div>
										<p class="lead mb-0">
											Awards Winner
										</p>
									</div>
		...
		<div class="section over-hide" id="footer">
			<div class="section-1400">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xl-4 text-center text-sm-left">
							<div class="section border-4 padding-top-bottom-80 px-4 px-md-5 bg-light-2">
								<h5 class="mb-4">Contact</h5>
								<a href="" class="link size-18 mb-1" data-hover="+33(0)1 43 65 79 19">+33(0)1 43 65 79 19</a> 
								<div class="clearfix w-100"></div>
								<a href="" class="link size-18 mb-1" data-hover="+38(0)6 34 62 54 77">+38(0)6 34 62 54 77</a> 
								<div class="clearfix w-100"></div>
								<a href="" class="link size-18 link-primary mb-fix-22 pb-1" data-hover="gaia-office@gaia.design">gaia-office@gaia.design</a>
							</div>
						</div>
						<div class="col-xl-8 mt-4 mt-xl-0 text-center text-sm-left">
							<div class="section border-4 padding-top-bottom-80 px-4 px-md-5 bg-light-2">
								<div class="row">
									<div class="col-sm-6 col-lg-3">
										<a href="about-us-creative.html" class="link size-18 mb-1 animsition-link" data-hover="About">About</a> 
										<div class="clearfix w-100"></div>
										<a href="contact-1.html" class="link size-18 mb-1 animsition-link" data-hover="Contact">Contact</a> 
										<div class="clearfix w-100"></div>
										<a href="blog-mixed.html" class="link size-18 mb-1 animsition-link" data-hover="Blog">Blog</a> 
										<div class="clearfix w-100"></div>
										<a href="services-creative.html" class="link size-18 mb-1 animsition-link" data-hover="Services">Services</a>
										<div class="clearfix w-100"></div> 
										<a href="portfolio-mixed.html" class="link size-18 animsition-link" data-hover="Portfolio">Portfolio</a> 
									</div>
									<div class="col-sm-6 col-lg-4">
										<a href="" class="link size-18 mb-1" data-hover="New Your City">New Your City</a> 
										<div class="clearfix w-100"></div>
									...
									<div class="col-lg-5 mt-5 mt-lg-0">
										<h5 class="mb-4">Join our awesome family</h5>
										<div class="row">
											<div class="col pr-0">
										...
										<p class="mb-0 size-13 color-secondary mt-1 mb-3 text-left">* we won´t spam you, never.</p>
										<a href="" class="link link-primary mb-1 mr-2" data-hover="Instagram">Instagram</a> 
										<a href="" class="link link-primary mb-1 mr-2" data-hover="Twitter">Twitter</a>
										<a href="" class="link link-primary mb-1" data-hover="LinkedIn">LinkedIn</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="row text-center text-md-left">
						...
						<div class="col-md order-md-first">
							<p class="mb-0 size-14 mt-1 font-weight-500">© 2020 IG Design. All Rights Reserved.</p>
						</div>
					</div>
				</div>
			</div>
